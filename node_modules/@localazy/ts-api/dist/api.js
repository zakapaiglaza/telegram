...
var LocalazyAPI = /** @class */ (function () {
    function LocalazyAPI() {
    }
    Object.defineProperty(LocalazyAPI, "get", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(LocalazyAPI, "getQueryString", {
        enumerable: true,
        configurable: true,
        writable: true,
        value: function (queries) { return Object.entries(queries)
            .reduce(function (acc, _a) {
            var key = _a[0], value = _a[1];
            return __spreadArray(__spreadArray([], acc, true), ["".concat(encodeURIComponent(key), "=").concat(encodeURIComponent(value))], false);
        }, [])
            .join('&'); }
    });
    return LocalazyAPI;
}());
exports.default = LocalazyAPI;
